...
import jetbrains.buildServer.agent.java.JavaExecutableProvider
...
class BesCommandLineBuilder(
    ...
    fun build(command: BazelCommand): ProgramCommandLine {
        ...
        return SimpleProgramCommandLine(
            ...
            _javaExecutableProvider.getJavaExecutable(),
            besArgs,
        )
    }
        ...
        val sb =
            buildString {
                ...
                for (arg in _argumentsConverter.convert(getArgs(command).asSequence())) {
                    ...
                    appendLine(virtualContext.resolvePath(unquotedArg))
                }
            }
