 ...
 */
class BazelBuildSessionFactory : MultiCommandBuildSessionFactory {

    override fun createSession(runnerContext: BuildRunnerContext) = BazelCommandBuildSession(runnerContext)
