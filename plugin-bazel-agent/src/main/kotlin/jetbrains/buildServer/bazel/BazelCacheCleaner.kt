...
class BazelCacheCleaner(
    ...
    override fun getCleanerName(): String = "Bazel Cache Cleaner"
    ...
    override fun registerDirectoryCleaners(
        ...
        _workspaceRegistry.workspaces.forEach {
            ...
            registry.addCleaner(
                it.path.absoluteFile,
                Date(it.path.lastModified()),
                WorkspaceCleaner(_buildStepContext, context, _workspaceRegistry, it, _commandLineExecutor),
            )
        }
    }
