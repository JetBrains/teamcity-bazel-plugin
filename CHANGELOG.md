...
- Fix BEP binary reader getting permanently stuck on unreadable events [#61](https://github.com/JetBrains/teamcity-bazel-plugin/pull/61)
- Too strict agent requirements for the Bazel runner [TW-93454](https://youtrack.jetbrains.com/issue/TW-93454)
