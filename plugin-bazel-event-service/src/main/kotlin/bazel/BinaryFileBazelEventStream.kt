...
class BinaryFileBazelEventStream(
    ...
    class Listener(
        ...
        private val _disposed = AtomicBoolean()
        private var _sequenceNumber: Long = 0
        ...
        private fun readBazelEvents(observer: Observer<BazelEvent>, channel: FileChannel) {
        ...
        private fun convertBazelEvent(event: BuildEventStreamProtos.BuildEvent): BazelEvent = BazelEvent(
            StreamId.default,
            _sequenceNumber++,
            Timestamp.zero,
    ...
    companion object {
        private val logger = Logger.getLogger(BinaryFileBazelEventStream::class.java.name)
    }
}
